function graph_spectral_entropy(SE, crs)
...
set(gca,'YTick',[fliplr(freqs(1:5:end-2)) ],'YTickLabel',[fliplr(round(1./(freqs(1:5:end-2)*60)))],...
    'FontName','Calibri','FontSize',7,'XTick',0:15:480,'XTickLabel',0:60:8*60)%,'Ylim',[.000105 .0010]) %%   ---> This is for the 8 hours interval 
...
%min
aux = interp1(1:mins:421,Xrec,1:mins*480,'cubic');  %%--> for chunk of 8*60
%min

%aux = interp1(1:mins:mins_MAX,Xrec,1:mins*72,'cubic');
hold on
%plot(1:72,aux,'linewidth',1,'color',cr,'linewidth',1) %%--> for chunk of 120
plot(1:480,aux,'linewidth',1,'color',cr,'linewidth',1) %%--> for chunk of 8*60
title('SE time course','FontName','Calibri','FontSize',9)
%set(gca,'Xlim',[0
%360],'XTick',[0:60:360],'FontName','Calibri','FontSize',8)  %% for the
%chunks of 120 min
set(gca,'Xlim',[0 480],'XTick',[0:60:480],'FontName','Calibri','FontSize',8)  %% for the the chunks of 8 hours
