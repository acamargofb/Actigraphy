...
plot(density(na.omit(Group_Subset$pk1_SE)))
plot(density(na.omit(Group_Subset$pk2_SE)))
plot(density(na.omit(Group_Subset$pk3_SE)))

hist(na.omit(Group_Subset$pk3_SE))
...
shapiro.test(Group_Subset$pk1)
shapiro.test(Group_Subset$pk2)
shapiro.test(Group_Subset$pk3)

shapiro.test(Group_Subset$pk1_SE)
shapiro.test(Group_Subset$pk2_SE)
shapiro.test(Group_Subset$pk3_SE)
