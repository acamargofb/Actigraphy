...
# Circadian
x <- data$Diagnosis
y <- data$Circ4d_Lomb   #==> Is close to significant p-value=0.11
...
mea_CircLombScar_MCS = mean(Group_Subset_MCS$Circ4d_Lomb)
std_CircLombScar_MCS = sd(Group_Subset_MCS$Circ4d_Lomb)
n_circLombScar_MCS = length(Group_Subset_MCS$Circ4d_Lomb)

mea_CircLombScar_UWS = mean(Group_Subset_UWS$Circ4d_Lomb)
std_CircLombScar_UWS = sd(Group_Subset_UWS$Circ4d_Lomb)
n_circLombScar_UWS = length(Group_Subset_UWS$Circ4d_Lomb)

library('R.matlab')
# Ultradian
table_Circ_Lomb_1<- data.frame(C_mean = mea_CircLombScar_MCS, C_sde = std_CircLombScar_MCS/sqrt(n_circLombScar_MCS))
table_Circ_Lomb_2 <- data.frame(C_mean = mea_CircLombScar_UWS, C_sde = std_CircLombScar_UWS/sqrt(n_circLombScar_UWS))

table_Circ_Lomb <- rbind(table_Circ_Lomb_1, table_Circ_Lomb_2)
writeMat("/home/aldo/Documents/Projects/Avtivemeter/Data/Comparison_3Methods/data_Circ_Lomb_errorplot_v2.mat", table_Circ_Lomb = data.matrix(table_Circ_Lomb))



#Ultradian

mea_Ultrad_LombScar_MCS = mean(Group_Subset_MCS$Ultr4d_Lomb)
std_Ultrad_LombScar_MCS = sd(Group_Subset_MCS$Ultr4d_Lomb)
n_Ultrad_LombScar_MCS = length(Group_Subset_MCS$Ultr4d_Lomb)

mea_Ultrad_LombScar_UWS = mean(Group_Subset_UWS$Ultr4d_Lomb)
std_Ultrad_LombScar_UWS = sd(Group_Subset_UWS$Ultr4d_Lomb)
n_Ultrad_LombScar_UWS = length(Group_Subset_UWS$Ultr4d_Lomb)


table_Ultr_Lomb_1<- data.frame(C_mean = mea_Ultrad_LombScar_MCS, C_sde = std_Ultrad_LombScar_MCS/sqrt(n_Ultrad_LombScar_MCS))
table_Ultr_Lomb_2 <- data.frame(C_mean = mea_Ultrad_LombScar_UWS, C_sde = std_Ultrad_LombScar_UWS/sqrt(n_Ultrad_LombScar_UWS))

table_Ultr_Lomb <- rbind(table_Ultr_Lomb_1, table_Ultr_Lomb_2)
writeMat("/home/aldo/Documents/Projects/Avtivemeter/Data/Comparison_3Methods/data_UltrLomb_errorplot_v2.mat", data_UltrLomb_errorplot = data.matrix(table_Ultr_Lomb))
...
mea_IV_MCS = mean(Group_Subset_MCS$IV_4d)
std_IV_MCS = sd(Group_Subset_MCS$IV_4d)
n_IV_MCS = length(Group_Subset_MCS$IV_4d)

mea_IV_UWS = mean(Group_Subset_UWS$IV_4d)
std_IV_UWS = sd(Group_Subset_UWS$IV_4d)
n_IV_UWS = length(Group_Subset_UWS$IV_4d)


table_IV_1 <- data.frame(C_mean = mea_IV_MCS, C_sde = std_IV_MCS/sqrt(n_IV_MCS))
table_IV_2 <- data.frame(C_mean = mea_IV_UWS, C_sde = std_IV_UWS/sqrt(n_IV_UWS))

table_Ultr_Lomb <- rbind(table_IV_1, table_IV_2)

writeMat("/home/aldo/Documents/Projects/Avtivemeter/Data/Comparison_3Methods/data_IV_errorplot_v2.mat", data_IV = data.matrix(table_Ultr_Lomb))
