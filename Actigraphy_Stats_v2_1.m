...
if(strcmp(segment,'morning'))
    ...
    path_mcs_ast = '/home/aldo/Documents/Projects/Avtivemeter/Files/AWD_Files/Only_morning/MCS_ast/';
    ...
    path_uws_ast = '/home/aldo/Documents/Projects/Avtivemeter/Files/AWD_Files/Only_morning/UWS_ast/';
...
cd(path_uws_ast);
SUBJlist_UWS_ast = dir('UWS_ast_*.mat');
...
[Cohens_d_control_LIS, effect_size_r_control_UWS_LIS] = effect_size(mean_control, mean_LIS, std_control, std_LIS)
...
y_MCS = mean(MCS_aux);
y_UWS = mean(UWS_aux);
y_UWS_nonTBI = mean(UWS_noTBI_aux);
y_UWS_TBI = mean(UWS_TBI_aux);

figure,
hh = plot(t_control, y_control, t_emcs, y_EMCS, t_lis, y_LIS, t_mcs, y_MCS, t_mcs_p, y_MCS_p, t_mcs_m, y_MCS_m, t_mcs_ast, y_MCS_ast, t_uws, y_UWS, t_uws_no_tbi, y_UWS_nonTBI,t_uws_tbi, y_UWS_TBI  );
legend(hh, 'Control', 'EMCS', 'LIS','MCS', 'MCS+ ', 'MCS- ', 'MCS*', 'UWS', 'UWS-nonTBI', 'UWS-TBI' )
title( 'Plot of Control, EMCS, LIS, MCS, MCS+, MCS-, MCS*, UWS, UWS-nonTBI, UWS-TBI')


%%% for Multiple Comparision

p_all_aux = [p_LIS_aux p_EMCS_aux p_MCS_aux p_MCS_m_aux p_MCS_p_aux p_MCS_p_aux p_UWS_aux p_UWS_TBI_aux p_UWS_nonTBI_aux];
